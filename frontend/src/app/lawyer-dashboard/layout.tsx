...
export default function LawyerDashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#f1f5f9] font-sans overflow-hidden">
      ...
      <header className="h-[72px] flex items-center justify-between z-20 flex-shrink-0 px-6 bg-white shadow-sm border-b border-gray-100 transition-all duration-300">
        ...
        {/* Navigation Links - Centered between Logo and Actions */}
          ...
          <div className="relative ml-2">
            ...
            >
              <div className="text-right leading-tight hidden sm:block">
                ...
                <p className="text-[10px] font-bold tracking-wider text-[#3b82f6]">{tx.advocate}</p>
              </div>
      ...
      {/* Main Content Rendered Here (Taking full remaining width and height) */}
